...
4. Preencha as informações necessárias e, em seguida, clique em **Examinar + Criar**.
    ...
    * **Tamanho** – o [SKU A](../../admin/service-admin-premium-purchase.md#purchase-a-skus-for-testing-and-other-scenarios) necessário. Para obter mais informações, confira [Memória e capacidade de computação do SKU](/power-bi/developer/embedded/embedded-capacity).
...
2. Preencha as informações necessárias e, em seguida, clique em **Examinar + Criar**.
    ...
    * **Local** – o local em que o Power BI está hospedado para seu locatário. O local padrão é sua região de residência, mas você pode alterar o local usando [Opções de Multi-Geo](https://docs.microsoft.com/power-bi/developer/embedded/embedded-multi-geo
).

    * **SKU** – o [SKU A](../../admin/service-admin-premium-purchase.md#purchase-a-skus-for-testing-and-other-scenarios) necessário. Para obter mais informações, confira [Memória e capacidade de computação do SKU](/power-bi/developer/embedded/embedded-capacity).
