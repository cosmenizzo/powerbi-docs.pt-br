...
![Um diagrama mostrando um pipeline de implantação com um ambiente de teste simulando o ambiente de produção.](media/deployment-pipelines-best-practices/deployment-pipelines-best-practices-diagram.png)
