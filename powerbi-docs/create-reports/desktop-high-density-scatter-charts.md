...
![Captura de tela de um gráfico de dispersão mostrando os dados de amostragem de alta densidade.](media/desktop-high-density-scatter-charts/high-density-scatter-charts_01.png)
...
* Se você clicar com o botão direito do mouse em um valor em **Detalhes** e defini-lo como **Mostrar itens sem dados** no menu, o gráfico de dispersão será revertido para o algoritmo original.
  ...
  ![Captura de tela do menu Visualização mostrando o painel Detalhes com a seleção de Mostrar itens sem dados.](media/desktop-high-density-scatter-charts/high-density-scatter-charts_02.png)
...
* O uso de uma **Linha de proporção** no painel **Análise** resulta na reversão do gráfico para o algoritmo original.
  ...
  ![Captura de tela do menu Visualização mostrando um ponteiro para o painel Análise e a Linha de proporção.](media/desktop-high-density-scatter-charts/high-density-scatter-charts_03.png)
...
![Captura de tela do menu Visualização mostrando um ponteiro para o painel Formatação, o cartão Geral e o controle deslizante de alternância Amostragem de alta densidade.](media/desktop-high-density-scatter-charts/high-density-scatter-charts_04.png)
