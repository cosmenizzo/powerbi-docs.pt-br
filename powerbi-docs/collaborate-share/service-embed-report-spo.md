...
> [!Note]
> Para organizações nas nuvens nacionais do Power BI, não há licença gratuita. Nesse ambiente, todos os usuários que desejam acessar o relatório inserido no SharePoint precisam ter uma licença do Power BI Pro.
