...
As entidades vinculadas exigem uma assinatura [Power BI Premium](../admin/service-premium-what-is.md) para atualizar. As entidades vinculadas estão disponíveis em qualquer fluxo de dados em um workspace que está hospedado na capacidade do Power BI Premium. Não há nenhuma limitação no fluxo de dados de origem.

As entidades vinculadas só funcionam corretamente em novos workspaces do Power BI. Saiba mais sobre os [novos workspaces do Power BI](../collaborate-share/service-create-the-new-workspaces.md). Todos os fluxos de dados vinculados devem estar localizados em novos workspaces para funcionar corretamente.
...
* O fluxo de dados deve residir em um [novo workspace do Power BI do Power BI](../collaborate-share/service-create-the-new-workspaces.md)
