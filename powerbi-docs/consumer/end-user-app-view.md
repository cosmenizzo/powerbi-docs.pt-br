...
Quando você seleciona o link no email, o serviço do Power BI ([https://powerbi.com](https://app/powerbi.com)) abre o aplicativo em um navegador. 
...
### <a name="open-an-app"></a>Abrir um aplicativo
...
![Captura de tela da lista de conteúdo Aplicativos](./media/end-user-app-view/power-bi-apps-list.png)
...
![Captura de tela de três opções: explorar, conectar e personalizar](./media/end-user-app-view/power-bi-customize.png)
...
![Captura de tela do estado de foco de um aplicativo mostrando nome, carimbo de data/hora, proprietário e ações. ](./media/end-user-app-view/power-bi-apps-hover.png)
...
![Captura de tela do aplicativo Vendas e Marketing com diferentes áreas identificadas por números ](./media/end-user-app-view/power-bi-app-numbered.png)
