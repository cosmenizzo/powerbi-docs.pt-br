...
4. Toque em **por** nas palavras-chave e em **item** na lista de sugestões > **Enviar** ![ícone Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).

    ![Vendas por item](./media/mobile-apps-ios-qna/power-bi-ios-q-n-a-sale-by-item.png)
5. Toque em **como** nas palavras-chave, toque no ícone de gráfico de colunas ![ícone de Gráfico](./media/mobile-apps-ios-qna/power-bi-ios-q-n-a-column-chart-icon.png) e em **Enviar** ![ícone Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).
6. Toque por alguns segundos o gráfico exibido, em seguida, toque em **Expandir**.

    ![Captura de tela de um gráfico de colunas mostrando um ponteiro para Expandir.](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-tap-expand-feedback.png)

    O gráfico será aberto no modo de foco no aplicativo.

    ![Captura de tela de um gráfico de colunas mostrando o modo de foco do gráfico.](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-expanded-chart.png)
...
9. Tente uma nova pergunta: Toque em **superior** nas palavras-chave, toque em **venda por $ médio/unidade** > **Enviar** ![ícone Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).

    ![Captura de tela de uma pergunta mostrando a venda superior por valor médio por unidade.](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-top-sale-2.png)
10. Selecione **por** nas palavras-chave, toque em **tempo** na lista de sugestões na parte superior > **Enviar** ![ícone Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).

     ![Captura de tela de um gráfico mostrando a venda superior por valor médio, por unidade e por tempo.](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-top-sale-by-time.png)
11. Digite **como**, selecione o ícone de gráfico de linhas ![ícone de Gráfico](./media/mobile-apps-ios-qna/power-bi-ios-q-n-a-line-chart-icon.png) na lista de sugestões > **Enviar** ![ícone Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).

    ![Captura de tela de um gráfico de colunas e linhas mostrando um ponteiro do gráfico de colunas para o gráfico de linhas](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-top-sale-as-line.png)
...
2. Toque no ícone de microfone ![Ícone de microfone](media/mobile-apps-ios-qna/power-bi-ios-qna-mic-icon.png).

    ![Captura de tela de uma pergunta mostrando que o microfone está ativo.](media/mobile-apps-ios-qna/power-bi-ios-qna-mic-on.png)

1. Quando o ícone de microfone estiver ativo, comece a falar. Por exemplo, diga "preço unitário médio por tempo" e toque em **Enviar** ![ícone de Enviar](./media/mobile-apps-ios-qna/power-bi-ios-qna-send-icon.png).

    ![Captura de tela de uma pergunta mostrando que a fala foi concluída.](media/mobile-apps-ios-qna/power-bi-ios-qna-speech-complete.png)
...
* Importa-se de fornecer comentários sobre os resultados? Toque por alguns segundos o gráfico ou outro resultado e, em seguida, toque na carinha feliz ou triste.
    ...
    ![Captura de tela de um gráfico de colunas mostrando um comentário com um ponteiro para um smiley.](media/mobile-apps-ios-qna/power-bi-ios-q-n-a-tap-feedback.png)
