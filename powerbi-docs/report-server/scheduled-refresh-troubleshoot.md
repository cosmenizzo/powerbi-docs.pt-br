...
O Rastreamento do SQL Server Profiler está incluído com o [download do SSMS (SQL Server Management Studio)](/sql/ssms/download-sql-server-management-studio-ssms).
