...
- [Habilitar acesso remoto ao Power BI Mobile com o Proxy de Aplicativo do Azure AD](/azure/active-directory/manage-apps/application-proxy-integrate-with-power-bi)
