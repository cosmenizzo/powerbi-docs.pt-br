...
Para obter mais informações sobre como criar e modificar agendas, consulte [Criar, modificar e excluir agendas](/sql/reporting-services/subscriptions/create-modify-and-delete-schedules).
