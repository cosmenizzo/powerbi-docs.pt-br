...
1. No Power BI, selecione **Obter Dados** na parte inferior do painel de navegação.
   ...
   ![Captura de tela do botão Obter Dados mostrando-o no painel de navegação.](media/service-connect-to-salesforce/pbi_getdata.png) 
2. Na caixa **Serviços** , selecione **Obter**.
   
   ![Captura de tela da caixa de diálogo Serviços mostrando o botão Obter.](media/service-connect-to-salesforce/pbi_getservices.png) 
3. Selecione **Análise para Salesforce** e selecione **Obter**.  
   
   ![Captura de tela da caixa de diálogo do Analytics for Salesforce mostrando o link Obter agora.](media/service-connect-to-salesforce/salesforce.png)
4. Selecione **Entrar** para iniciar o fluxo de conexão.
   
    ![Captura de tela da caixa de diálogo Conectar-se ao Salesforce mostrando o botão Entrar.](media/service-connect-to-salesforce/dialog.png)
5. Quando solicitado, insira suas credenciais do Salesforce. Selecione **Permitir** e permita que o Power BI acesse suas informações e dados básicos do Salesforce.
   ...
   ![Captura de tela das credenciais do Salesforce mostrando que o Power BI está solicitando permissão para acessar suas informações.](media/service-connect-to-salesforce/sf_authorize.png)
6. Configure o que você desejaria importar para o Power BI usando a opção de lista suspensa:
   ...
   * **Painel**
     ...
     ![Captura de tela do dashboard do Salesforce mostrando a opção para selecionar um dashboard predefinido com base em uma persona.](media/service-connect-to-salesforce/pbi_salesforcechooserole.png)
   * **Relatórios**
     ...
     ![Captura de tela dos relatórios do Salesforce mostrando uma lista de relatórios personalizados.](media/service-connect-to-salesforce/pbi_salesforcereports.png)
...
7. Selecione **Conectar** para iniciar o processo de importação. Durante a importação, você verá uma notificação mostrando que a importação está em andamento. Quando a importação for concluída, você verá um dashboard, relatório e conjunto de dados para seus dados do Salesforce listados no painel de navegação.
   ...
   ![Captura de tela do dashboard do Gerenciador de Vendas mostrando o dashboard, o relatório e os conjuntos de dados.](media/service-connect-to-salesforce/pbi_getdatasalesforcedash.png)
...
Se você receber uma mensagem "Não é possível conectar ao servidor remoto" ao tentar se conectar à sua conta do Salesforce, confira esta solução no fórum: [Mensagem de erro na conexão do Salesforce Connector: Não é possível se conectar ao servidor remoto](https://www.outsystems.com/forums/Forum_TopicView.aspx?TopicId=17674&TopicName=log-in-error-message-unable-to-connect-to-the-remote-server&)
